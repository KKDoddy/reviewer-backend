...
import { validateRideAction, hasNoRecentRide } from '../middlewares/rideActionValidations';

const router = Router();

router.post('/new', tokenValidator, isCommuter, validateForm, hasNoRecentRide, saveRideRequest);
